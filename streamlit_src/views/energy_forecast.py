...
from views import home, goal, dataset, analysis, conclusion, options, login, logout, energy_forecast
import sys
import os
import utils as utl
from router import get_route, redirect
import json
...
def load_view():
    ...
    past_prediction_files = [f for f in os.listdir(r"C:\Users\Henri\Documents\GitHub\Predi_Conso_Elec_Region\streamlit_src\data_sample\pred\NAQ\2025-05\2025-05-03\14\pred") if f.startswith("plot_full_pred_")]
    ...
    file_path = os.path.join(r"C:\Users\Henri\Documents\GitHub\Predi_Conso_Elec_Region\streamlit_src\data_sample\pred\NAQ\2025-05\2025-05-03\14\pred", random_prediction_file)
