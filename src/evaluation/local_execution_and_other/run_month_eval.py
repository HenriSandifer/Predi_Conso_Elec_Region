from run_full_day_eval import run_prediction_evaluation
import calendar
from datetime import datetime
import argparse

def run_all_eval_for_month(func_region, target_month, target_year):
    ...
    for day in range(start_day, num_days + 1):
        ...
        run_prediction_evaluation(func_region, date_str)

    print(f"🏁 Finished evaluations for {target_month} {target_year} in {func_region}.")
...
if __name__ == "__main__":
    ...
    run_all_eval_for_month(args.region, args.month, args.year)